...
exports.default = function () {
  return {
    contract: { name: "@tripetto/runner-autoscroll", version: "9.0.1" },
    customLocale: true,
    availableTranslations: ["en", "de", "es", "fr", "id", "nl", "pl", "pt"],
    strings: [
      "runner#1|🆗 Buttons\u0004Back",
      "runner#1|🆗 Buttons\u0004Discard",
      "runner#1|🆗 Buttons\u0004Next",
      "runner#1|🆗 Buttons\u0004Reload",
      "runner#1|🆗 Buttons\u0004Retry",
      "runner#1|🆗 Buttons\u0004Start",
      "runner#1|🆗 Buttons\u0004Start again",
      ...
      "runner#2|💬 Messages|Conversation paused\u0004⏸ Paused",
      "runner#3|🩺 Status information\u0004%1 of %2 answered",
      "runner#3|🩺 Status information\u0004Nothing to answer",
      "runner#3|🩺 Status information\u0004Pausing...",
      "runner#3|🩺 Status information\u0004Submitting...",
      "runner#3|🩺 Status information\u0004⏳ One moment please...",
      "runner#6|✍️ Signature\u0004Clear",
      "runner#6|✍️ Signature\u0004Processing signature (%1)",
      "runner#6|✍️ Signature\u0004Signed on %1",
