...
exports.InputFabric = exports.InputElement = void 0;
...
exports.InputElement = styled_components_1.styled.input(
    templateObject_1 ||
...
var InputFabric = function (props) {
                      ...
                      function (val) {
                          ...
                          debounceRef.current.handle = (0, runner_1.scheduleUITimeout)(function () {
                              ...
                              if (props.type === "url" && val && val.toLowerCase().indexOf("://") === -1) {
                                  valueRef.pristine = "https://".concat(val);
                              } else {
    ...
    return (0, jsx_runtime_1.jsx)(exports.InputElement, {
        id: props.id,
        ref: setRef,
...
exports.InputFabric = InputFabric;
