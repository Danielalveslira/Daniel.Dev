const topFacialHair = (type, color) => {
    let facialHairColor;
    switch (color) {
        case "Auburn":
        ...
        case "BeardMedium":
            return `
                <g transform="translate(49.000000, 72.000000)">
                    ...
                    <g mask="url(#top-facial-hair-beard-medium-mask)" fill="${facialHairColor}">
        ...
        case "BeardLight":
            return `
                <g transform="translate(49.000000, 72.000000)">
                    ...
                    <g mask="url(#top-facial-hair-beard-light-mask)" fill="${facialHairColor}">
                        <g transform="translate(-32.000000, 0.000000)">
                            <rect x="0" y="0" width="264" height="244"></rect>
                        </g>
                    </g>
        ...
        case "MoustacheFancy":
            return `
                <g transform="translate(49.000000, 72.000000)">
                    ...
                    <g mask="url(#top-facial-hair-moustache-fancy-mask)" fill="${facialHairColor}">
                        <g transform="translate(-32.000000, 0.000000)">
                            <rect x="0" y="0" width="264" height="244"></rect>
                        </g>
                    </g>
        ...
        case "MoustacheMagnum":
            return `
                <g transform="translate(49.000000, 72.000000)">
                    ...
                    <g mask="url(#top-facial-hair-moustache-magnum-mask)" fill="${facialHairColor}">
                        <g transform="translate(-32.000000, 0.000000)">
                            <rect x="0" y="0" width="264" height="244"></rect>
                        </g>
                    </g>
