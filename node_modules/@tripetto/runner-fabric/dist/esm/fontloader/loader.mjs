import { scheduleAnimation, arraySize, findFirst, scheduleFrame } from "@tripetto/runner";
...
class FontLoader {
    ...
    static load() {
        ...
        if (arraySize(this.requests) > 0) {
            ...
            if (nextRequest) {
                ...
                })((typeof window === "undefined" && {}) || window, (typeof module === "undefined" && { exports: {} }) || module).load(
                    Object.assign(Object.assign({}, config), {
                        classes: false,
                        fontactive: (familyName) => this.done(nextRequest, font, familyName),
                        inactive: () => this.done(nextRequest, font, nextRequest.fallback || ""),
                        context: (_a = nextRequest.context) === null || _a === void 0 ? void 0 : _a.current.contentWindow,
                    })
                );
            } else {
    ...
    static done(request, font, familyName) {
    ...
    static request(id, ref, context, set, fallback) {
